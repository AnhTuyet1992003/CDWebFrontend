                ...
                const products = await Promise.all(
                    importOrder.products.map(async (product) => {
                        try {
                            ...
                            console.log(productSizeColorResponse.data)
                            ...
                            await fetchColorsAndSizes(product.product_size_colorId);

                            // return {
                            //     productId: productSizeColor2.productId,
                            ...
                            //     price: product.importPrice.toString(),
                            // };
                            return {
                                ...
                                color: productSizeColor.colorName,
                                size: productSizeColor.sizeName,
                                quantity: product.quantity, // Dòng 89 (có thể)
                                price: product.price,
                            };
                        } catch (error) {
